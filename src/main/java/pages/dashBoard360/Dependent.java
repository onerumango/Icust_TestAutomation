...
public class Dependent extends IcustSpecificMethods{
	...
	public Dependent clickExistingCustomer() {
		clickElement(locateElement("xpath", props.getProperty("Dependent.toggle.Xpath")));
		wait(5000);
		return this;
		}
	
	public Dependent enterCifNumber() {
		
		enterValue(locateElement("xpath", props.getProperty("Dependent.CifNumber.Xpath")),props.getProperty("CifNumber"));
		wait(5000);
		return this;
	}
